...
@app_views.route('/lodges/<lodge_id>/reviews', methods=['GET'],
                 strict_slashes=False)
@swag_from('documentation/reviews/get_reviews.yml', methods=['GET'])
def get_reviews(lodge_id):
    """
    Retrieves the list of all Review objects of a Lodge
    """
...
@app_views.route('/lodges/<lodge_id>/reviews', methods=['POST'],
                 strict_slashes=False)
@swag_from('documentation/reviews/post_reviews.yml', methods=['POST'])
def post_review(lodge_id):
    """
    Creates a Review
    """
    lodge = storage.get(Lodge, lodge_id)
